...
def register():
    ...
    if not username or not email or not password:
        return create_error_response("Missing username, email or password", 400)
    ...
    return create_success_response("User registered successfully", 
    201, 
    {
...
def login():
    ...
    if not email or not password:
        return create_error_response("Missing email or password", 400)
    ...
    return create_success_response("User logged in successfully", data={
    "access_token": access_token, 
    "refresh_token": refresh_token,
...
def refresh():
    ...
    return create_success_response("Token refreshed successfully", data={"access_token": new_access_token})
